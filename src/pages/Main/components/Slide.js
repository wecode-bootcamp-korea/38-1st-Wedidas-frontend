...
const Slide = () => {
  ...
  useEffect(() => {
    ...
    slideRef.current.style.transform = `translateX(-${currentSlide * 24.5}%)`;
  ...
  return (
    <div className="bestSection">
      <h2 className="title">BEST OF ADIDAS</h2>
      ...
      <button onClick={prevSlide} className="prevBtn slideBtn">
        <BsArrowLeft />
      </button>
      <button onClick={nextSlide} className="nextBtn slideBtn">
        <BsArrowRight />
      </button>
